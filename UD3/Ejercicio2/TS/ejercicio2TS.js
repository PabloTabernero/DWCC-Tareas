...
var calcularDias = function () {
    ...
    var fechaObjetivo = new Date("2024-05-25");
    var diasRestantes = Math.floor((fechaObjetivo.getTime() - fechaActual.getTime()) / (1000 * 60 * 60 * 24));
...
var proximosCumplesEnFinde = function () {
    var fecha = prompt("Introduce la fecha tu cumpleaños (YYYY-MM-DD): ");
    if (fecha !== null) {
        var fechaCumpleanos = new Date(fecha);
        ...
        var fechaMaxima = new Date("2100-01-01");
        while (fechaCumpleanos < fechaMaxima) {
            var diaSemanaCumpleanos = fechaCumpleanos.getDay();
...
var elegirFormatoFecha = function () {
    var opcion = prompt("Introduce un numero del 1 al 3 para seleccionar el formato de fecha: ");
    var fechaActual = new Date();
    switch (opcion) {
        case "1":
 ...
 */
var elegirFormatoHora = function () {
    var opcion = prompt("Introduce un numero del 1 al 2 para seleccionar el formato de hora: ");
    var fechaActual = new Date();
    switch (opcion) {
        case "1":
